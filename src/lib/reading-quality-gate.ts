...
1. chart_evidence — Are major claims traceable to specific placements, houses, aspects, dignity, rulership, dispositors, nodes, dashas, or synthesis factors actually present in the chart context? Generic claims with no chart anchor score low. Score LOW for Barnum / unfalsifiable claims: statements almost any reader would endorse regardless of their chart ("you feel most like yourself when the exchange is mutual", "the sense of self can go when the relational field is unclear", "you need both connection and independence", "you feel things deeply"). Apply the inversion test — if the opposite would sound equally true of the reader and the claim is not anchored to a named placement, it does comfort work, not astrological work, and must score low here.
...
4. contradiction_handling — Does it name paradoxes, tensions, and mixed expressions? When two placements pull in opposite directions, is the contradiction held open rather than averaged away? Score LOW for the compensatory-reframe compulsion: every difficulty (a fall, detriment, debilitation, or tight hard aspect) rehabilitated into a hidden virtue inside the same paragraph it is raised — "fall does not mean broken → genuinely uncommon", "serial destabilisation → a form of resilience", "porousness → genuine empathy". This is forced emotional resolution, the affective twin of averaging a tension away. A passing section leaves at least one named constraint uncompensated — stated as a cost with no redemptive upside attached to it anywhere in the section. A real gift located on its OWN separate placement is fine; converting the wound just named into its own silver lining is the fault.
5. anti_cliche — Does it avoid sun-sign clichés (Scorpio = secretive, Virgo = critical, Leo = needing spotlight), vague affirmations ("your sensitivity is a gift"), and horoscope-voice phrasing? A universally-true comfort claim (see criterion 1's Barnum test) is a horoscope in disguise and scores low here too.
